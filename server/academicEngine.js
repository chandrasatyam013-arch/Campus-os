export class AcademicEngine {
     ...
     */
    static calculateGrade(percentage, gradingSystem = '10_POINT') {
     ...
     */
    static evaluateSubject(subject, marks, gradingSystem) {
     ...
     */
    static evaluateAllSubjects(subjects, marks, gradingSystem) {
     ...
     */
    static evaluateSemesters(subjects, performances) {
     ...
     */
    static calculateTarget(targetCGPA, completedCredits, currentCGPA, remainingCredits, gradingSystem = '10_POINT') {
     ...
     */
    static calculateAcademicRisk(cgpa, weakSubjectsCount, trend, gradingSystem) {
        if (cgpa === null)
            return 'SAFE';
