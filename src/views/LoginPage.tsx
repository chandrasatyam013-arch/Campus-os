...
import { Compass, ArrowRight, Lock, Mail, ShieldCheck } from 'lucide-react';
...
export const LoginPage: React.FC<LoginPageProps> = ({ onNavigateToRegister, onNavigateToLanding, onNavigateToForgotPassword
  ...
  toast.success('Welcome back!', 'Successfully signed in to Campus OS.');
    }
  catch (err: any) { toast.error('Sign In Failed', err.message);
    }
  ...
  const handleGoogleLogin = async () => {
    const url = 'https://campus-os-pi.vercel.app/api/auth/google' + (Capacitor.isNativePlatform() ? '?platform=android' : '');
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col justify-center items-center px-4 selection:bg-black selection:text-white">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-500 mt-1"> Access your attendance intelligence, SGPA models, and daily action engine.
          </p>
        </div>
        ...
        <div className="flex justify-center items-center">
          <form onSubmit={handleSubmit} className="form">
            <div className="title">Campus OS<br/><span>sign in to continue</span></div>
            ...
            <div className="w-full relative">
              ...
              <button type="button" onClick={onNavigateToForgotPassword} className="absolute right-2 top-10 text-[10px] text-gray-500 hover:text-black font-bold">
                Forgot password?
              </button>
            </div>
            ...
            <div className="login-with flex flex-col items-start gap-1">
              ...
              <div className="flex gap-2">
                <button type="button" onClick={handleGoogleLogin} title="Google Sign-In" className="button-log">
            ...
            <div className="mt-2 text-center text-xs text-[var(--font-color-sub)] w-full">
              ...
              <button type="button" onClick={onNavigateToRegister} className="font-bold text-[var(--font-color)] hover:underline">
                Create one now
              </button>
            </div>
          </form>
